...
public class ExtendedFunctionalityTests_Field
{
    ...
    {
        [ShimProxy(typeof(ProxyImpl_AddField), ProxyBehaviour.Add)]
        string Field { get; set; }
    }
    [ExcludeFromCodeCoverage]
    public class ProxyImpl_AddField
    {
        public static string Field { get; set; } = null!;
    }
    ...
    public void Can_add_field_proxy()
    {
        ...
        // Assert
        Assert.AreEqual("test", ProxyImpl_AddField.Field);
    }

    public interface ITestShim_AddFieldDefault
    {
        [ShimProxy(typeof(ProxyImpl_AddFieldDefault), "Field")]
        string Field { get; set; }
    }
    [ExcludeFromCodeCoverage]
    public class ProxyImpl_AddFieldDefault
    {
        public static string Field { get; set; } = null!;
    }
    ...
    {
        [ShimProxy(typeof(ProxyImpl_OverrideField), ProxyBehaviour.Override)]
        string Field { get; set; }
    }
    [ExcludeFromCodeCoverage]
    public class ProxyImpl_OverrideField
    {
        public static string Field { get; set; } = null!;
    }
    ...
    public void Can_override_field_proxy()
    {
        ...
        Assert.AreEqual("test", ProxyImpl_OverrideField.Field);
    }

    public interface ITestShim_OverrideFieldDefault
    {
        [ShimProxy(typeof(ProxyImpl_OverrideFieldDefault))]
        string Field { get; set; }
    }
    [ExcludeFromCodeCoverage]
    public class ProxyImpl_OverrideFieldDefault
    {
        public static string Field { get; set; } = null!;
    }
    ...
    {
        [Shim("Field")]
        [ShimProxy(typeof(ProxyImpl_OverrideFieldAlias), "FieldProxy", ProxyBehaviour.Override)]
        string FieldShim { get; set; }
    }
    [ExcludeFromCodeCoverage]
    public class ProxyImpl_OverrideFieldAlias
    {
        public static string FieldProxy { get; set; } = null!;
    }
    ...
    public void Can_override_field_proxy_with_aliases()
    {
        ...
        // Assert
        Assert.IsNull(obj.Field);
        Assert.AreEqual("test", ProxyImpl_OverrideFieldAlias.FieldProxy);
    }

    // TODO
    //public interface ITestShim_FieldMethods
    //{
    //    [ShimProxy(typeof(ProxyImpl_FieldMethods))]
    //    string Field { get; set; }
    //}
    //[ExcludeFromCodeCoverage]
    //[SuppressMessage("Style", "IDE1006:Naming Styles")]
    //public class ProxyImpl_FieldMethods
    //{
    //    private static bool _inProxy = false;
    //    public static string FieldValue { get; private set; } = null!;
