...
public class ConstructorTests
{
    ...
    public void Can_not_shim_to_constructor_with_void_return_type()
    {
        try
        {
            _ = ShimBuilder.Create<IFactoryInterface2>();
        }
#if !SHIMRGEN
        ...
        {
            Assert.AreEqual("Unable to create a static shim of type IFY.Shimr.Tests.ConstructorTests+IFactoryInterface2", ex.Message); // TODO: better message
#endif
            return;
        }
    ...
    public void Can_not_shim_to_constructor_with_incorrect_return_type()
    {
        try
        {
            _ = ShimBuilder.Create<IFactoryInterface3>();
        }
#if !SHIMRGEN
        catch (ArgumentException ex)
        {
        ...
        {
            Assert.AreEqual("Unable to create a static shim of type IFY.Shimr.Tests.ConstructorTests+IFactoryInterface3", ex.Message); // TODO: better message
#endif
            return;
        }
    ...
    public void Can_not_shim_to_missing_constructor()
    {
        try
        {
            _ = ShimBuilder.Create<IFactoryInterface5>();
        }
#if !SHIMRGEN
        ...
        {
            Assert.AreEqual("Unable to create a static shim of type IFY.Shimr.Tests.ConstructorTests+IFactoryInterface5", ex.Message); // TODO: better message
#endif
            return;
        }
