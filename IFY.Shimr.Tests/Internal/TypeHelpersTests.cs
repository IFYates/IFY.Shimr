...
public class TypeHelpersTests
{
    ...
    public void GetMethod__Generic_method_No_parameter__Match()
    {
        ...
        // Act
        var res = typeof(TestClass1).GetMethod(method2.Name, params2, genArgs2, null);
    ...
    {
        // Act
        var res = TypeHelpers.GetMethod(typeof(TestClass2), "FixedParamX", [typeof(string)], new Type[1], null);
    ...
    {
        // Act
        var res = TypeHelpers.GetMethod(typeof(TestClass2), "FixedParam", [typeof(int)], new Type[1], null);
    ...
    {
        // Act
        var res = TypeHelpers.GetMethod(typeof(TestClass2), "FixedParam", [typeof(string)], new Type[2], null);
