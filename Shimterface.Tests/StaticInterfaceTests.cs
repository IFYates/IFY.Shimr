...
namespace Shimterface.Tests
{
    ...
    public class StaticInterfaceTests
    {
        ...
        [StaticShim(typeof(StaticMemberClass), IsConstructor = true)]
        public interface IStaticInterface4
        {
            void Test();
        }
        [TestMethod]
        [ExpectedException(typeof(NotSupportedException))]
        public void Cannot_define_StaticShim_interface_as_constructor()
        {
            ShimBuilder.Create<IStaticInterface4>();
        }
    }
}